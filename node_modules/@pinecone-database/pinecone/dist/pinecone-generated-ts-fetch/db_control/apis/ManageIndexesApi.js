...
class ManageIndexesApi extends runtime.BaseAPI {
     ...
     * Create an index from a backup
     */
    async createIndexFromBackupRaw(requestParameters, initOverrides) {
     ...
     * Create an index from a backup
     */
    async createIndexFromBackup(requestParameters, initOverrides) {
     ...
     */
    async listProjectBackupsRaw(initOverrides) {
        const queryParameters = {};
        const headerParameters = {};
        if (this.configuration && this.configuration.apiKey) {
            headerParameters["Api-Key"] = this.configuration.apiKey("Api-Key"); // ApiKeyAuth authentication
     ...
     * List backups for all indexes in a project
     */
    async listProjectBackups(initOverrides) {
